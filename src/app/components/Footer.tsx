  ...
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X_Condensed"]'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
           ...
           <h1 className='text-[8vw]  font-semibold uppercase leading-none -mb-7'>Eye-</h1>
           <h1 className='text-[8vw]  font-semibold uppercase leading-none -mb-7'>Opening</h1>
           </div>
        ...
        <h1 className='text-[8vw]  font-semibold uppercase leading-none '>Presentations
        </h1>
